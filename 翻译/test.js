...
function(e, t) { !
    function(e, t) {
        ...
        E = function(e) {
            ...
            else if ("number" == typeof e.length) for (t = [], n = 0, r = e.length; n < r; n++) w.call(e, n) && (t[n] = E(e[n]));
            else {
                t = {};
                for (i in e) w.call(e, i) && (t[i] = E(e[i]))
            }
            return t
        },
        k = function(e, t) {
        ...
        G = function(e) {
            "object" != typeof e || !e || "length" in e || x(e).forEach(function(t) {
                ...
                if ("string" != typeof e || !e) return E(K);
        ...
        J = function() {
            return Ye(),
            {
                browser: S(k(s, ["userAgent", "platform", "appName", "appVersion"]), {
                    isSupported: Q()
                }),
                flash: j(P, ["bridge"]),
                zeroclipboard: {
        ...
        ee = function() {
            return !! (P.sandboxed || P.disabled || P.outdated || P.unavailable || P.degraded || P.deactivated)
        },
        te = function(e, t) {
            var r, i, o, a = {};
            if ("string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
                ...
                q[e] || (q[e] = []),
                q[e].push(t);
                if (a.ready && P.ready && Ke.emit({
                    type: "ready"
                }), a.error) {
                    for (Q() || Ke.emit({
                        type: "error",
                        name: "browser-unsupported"
                    }), r = 0, i = V.length; r < i; r++) if (!0 === P[V[r].replace(/^flash-/, "")]) {
                        Ke.emit({
                            type: "error",
                            name: V[r]
                        });
        ...
        ne = function(e, t) {
            var n, r, i, o, a;
            if (0 === arguments.length ? o = x(q) : "string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
                var n = e[t];
                "function" == typeof n && Ke.off(t, n)
            }), o && o.length) for (n = 0, r = o.length; n < r; n++) if (e = o[n].replace(/^on/, ""), (a = q[e]) && a.length) if (t) for (i = a.indexOf(t); - 1 !== i;) a.splice(i, 1),
            i = a.indexOf(t, i);
            else a.length = 0;
            return Ke
        },
        re = function(e) {
            return "string" == typeof e && e ? E(q[e]) || null: E(q)
        },
        ie = function(e) {
            var t, n, r;
            if ((e = me(e)) && !Te(e)) return "ready" === e.type && !0 === P.overdue ? Ke.emit({
                type: "error",
                name: "flash-overdue"
            }) : (t = S({},
            e), xe.call(this, t), "copy" === e.type && (n = (r = De(B)).data, U = r.formatMap), n)
        },
        oe = function() {
            var e = K.swfPath || "",
            t = e.slice(0, 2),
        ...
        ae = function() {
            var e, t, n = P.sandboxed;
            if (!Q()) return P.ready = !1,
            void Ke.emit({
                type: "error",
                name: "browser-unsupported"
            });
            ...
            P.sandboxed !== n && !0 === P.sandboxed ? (P.ready = !1, Ke.emit({
                type: "error",
                name: "flash-sandboxed"
            })) : Ke.isFlashUnusable() || null !== P.bridge || ((t = oe()) && t !== o.location.protocol ? Ke.emit({
                type: "error",
                name: "flash-insecure"
            }) : ("number" == typeof(e = K.flashLoadTimeout) && e >= 0 && (z = l(function() {
                "boolean" != typeof P.deactivated && (P.deactivated = !0),
                !0 === P.deactivated && Ke.emit({
                    type: "error",
        ...
        ce = function(e) {
            void 0 === e ? (N(B), U = null) : "string" == typeof e && w.call(B, e) && delete B[e]
        },
        ue = function(e) {
            return void 0 === e ? E(B) : "string" == typeof e && w.call(B, e) ? B[e] : void 0
        },
        fe = function(e) {
            if (e && 1 === e.nodeType) {
                r && (Pe(r, K.activeClass), r !== e && Pe(r, K.hoverClass)),
                r = e,
                He(e, K.hoverClass);
                ...
                var i = !0 === K.forceHandCursor || "pointer" === qe(e, "cursor");
                $e(i),
                We()
            }
        },
        de = function() {
            ...
            r && (Pe(r, K.hoverClass), Pe(r, K.activeClass), r = null)
        },
        pe = function() {
            return r || null
        },
        ...
        Te = function(e) {
            ...
            case "error":
                ...
                "boolean" == typeof a && (P.sandboxed = a),
                "browser-unsupported" === e.name ? S(P, {
                    disabled: !1,
                    outdated: !1,
                    unavailable: !1,
                    degraded: !1,
                    ...
                    ready: !1
                }) : "version-mismatch" === e.name && (n = e.swfVersion, S(P, {
                    disabled: !1,
                    outdated: !1,
                    insecure: !1,
                    unavailable: !1,
        ...
        Se = function() {
            ...
            if ("number" == typeof e && e >= 0) {
                ...
                W = u(function() {
                    ...
                    Ue(e) && (ze(), P.deactivated = null, Ke.emit({
                        type: "error",
                        name: "swf-not-found"
                    }))
                },
        ...
        Ae = function() {
            ...
            if (e) {
                var t = ke(e);
                t && ("activex" === P.pluginType && "readyState" in e ? (e.style.display = "none",
                function n() {
                    if (4 === e.readyState) {
        ...
        Be = function(e) {
            ...
            if (e.getBoundingClientRect) {
                ...
                c = 0,
                u = 0;
                if ("relative" === qe(a.body, "position")) {
        ...
        $e = function(e) { ! 0 === P.ready && (P.bridge && "function" == typeof P.bridge.setHandCursor ? P.bridge.setHandCursor(e) : P.ready = !1)
        },
        Xe = function(e) {
        ...
        Ze = function(e) {
            ...
            P.disabled = !0 !== a,
            P.outdated = u && v(u) < v("11.0.0"),
            P.version = u || "0.0.0",
            P.pluginType = c ? "pepper": l ? "activex": a ? "netscape": "unknown"
        };
        Ze(h),
        Ye(!0);
        var Ke = function() {
        ...
        rt = function(e, t) {
            ...
            if ("string" == typeof e && e ? o = e.toLowerCase().split(/\s+/) : "object" != typeof e || !e || "length" in e || void 0 !== t || x(e).forEach(function(t) {
                ...
                c[e] || (c[e] = []),
                c[e].push(t);
                if (a.ready && P.ready && this.emit({
                    type: "ready",
                    client: this
                }), a.error) {
                    for (r = 0, i = V.length; r < i; r++) if (P[V[r].replace(/^flash-/, "")]) {
                        this.emit({
                            type: "error",
                            name: V[r],
                            client: this
    ...
    function(t) {
        ...
        e.fn.ajaxSubmit = function(t, n, i, s) {
            ...
            function c(n) {
                ...
                function s(t) {
                    if (!y.aborted && !L) {
                        if ((O = i(g)) || (r("cannot access response document"), t = j), t === k && y) return y.abort("timeout"),
            ...
            k = p.attr("enctype") === E || p.attr("encoding") === E,
            j = o.fileapi && o.formdata;
            r("fileAPI :" + j);
            var N, A = (S || k) && !j; ! 1 !== t.iframe && (t.iframe || A) ? t.closeKeepAlive ? e.get(t.closeKeepAlive,
            function() {
                N = c(y)
            }) : N = c(y) : N = (S || k) && j ?
            function(n) {
...
function(e, t) {
    return function(e, t) {
        ...
        function T(e, t, n, r) {
            ...
            function(t, i) {
                n || ze.test(e) ? r(e, i) : T(e + "[" + ("object" == typeof i || M.isArray(i) ? t: "") + "]", i, n, r)
            });
        ...
        M = function() {
            ...
            s.extend({
                ...
                camelCase: function(e) {
                    return e.replace(S, "ms-").replace(C, E)
                },
        ...
        M.fn.extend({
            ...
            removeClass: function(e) {
                ...
                if (e && "string" == typeof e || e === t) for (n = (e || "").split(W), r = 0, i = this.length; r < i; r++) if (1 === (o = this[r]).nodeType && o.className) if (e) {
                    for (a = (" " + o.className + " ").replace(z, " "), s = 0, l = n.length; s < l; s++) a = a.replace(" " + n[s] + " ", " ");
            ...
            toggleClass: function(e, t) {
                ...
                return M.isFunction(e) ? this.each(function(n) {
                    ...
                    a = M(this), s = t, l = e.split(W); i = l[o++];) a[(s = r ? s: !a.hasClass(i)) ? "addClass": "removeClass"](i);
            ...
            hasClass: function(e) {
                for (var t = " " + e + " ",
                n = 0,
                r = this.length; n < r; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(z, " ").indexOf(t) > -1) return ! 0;
                return ! 1
            },
            val: function(e) {
                var n, r, i, o = this[0];
                ...
                })) : o ? (n = M.valHooks[o.nodeName.toLowerCase()] || M.valHooks[o.type]) && "get" in n && (r = n.get(o, "value")) !== t ? r: "string" == typeof(r = o.value) ? r.replace($, "") : null == r ? "": r: t
            }
        }),
        M.extend({
            valHooks: {
            ...
            attr: function(e, n, r, i) {
                ...
                return e && 3 !== l && 8 !== l && 2 !== l ? i && n in M.attrFn ? M(e)[n](r) : "getAttribute" in e ? ((s = 1 !== l || !M.isXMLDoc(e)) && (n = n.toLowerCase(), a = M.attrHooks[n] || (Z.test(n) ? B: q)), r !== t ? null === r ? (M.removeAttr(e, n), t) : a && "set" in a && s && (o = a.set(e, r, n)) !== t ? o: (e.setAttribute(n, "" + r), r) : a && "get" in a && s && null !== (o = a.get(e, n)) ? o: null === (o = e.getAttribute(n)) ? t: o) : M.prop(e, n, r) : t
            },
            removeAttr: function(e, t) {
                var n, r, i, o, a = 0;
                if (1 === e.nodeType) for (o = (r = (t || "").split(W)).length; a < o; a++) i = r[a].toLowerCase(),
                n = M.propFix[i] || i,
                M.attr(e, i, ""),
            ...
            attrHooks: {
                ...
                value: {
                    ...
                    set: function(e, t, n) {
                        if (q && M.nodeName(e, "button")) return q.set(e, t, n);
                        e.value = t
                    }
                }
            },
        ...
        q = M.valHooks.button = {
            get: function(e, n) {
                var r;
                return (r = e.getAttributeNode(n)) && (U[n] ? "" !== r.nodeValue: r.specified) ? r.nodeValue: t
            },
            set: function(e, t, n) {
        ...
        M.attrHooks.tabindex.set = q.set, M.each(["width", "height"],
        function(e, t) {
        ...
        Ee.th = Ee.td,
        M.support.htmlSerialize || (Ee._default = [1, "div<div>", "</div>"]),
        M.fn.extend({
            text: function(e) {
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || xe.test(e) || !M.support.leadingWhitespace && me.test(e) || Ee[(ve.exec(e) || ["", ""])[1].toLowerCase()]) M.isFunction(e) ? this.each(function(t) {
                    var n = M(this);
            ...
            clean: function(e, t, n, r) {
                ...
                for (var o, a, s = [], l = 0; null != (a = e[l]); l++) if ("number" == typeof a && (a += ""), a) {
                    if ("string" == typeof a) if (be.test(a)) {
                        ...
                        for (t === O ? ke.appendChild(p) : u(t).appendChild(p), p.innerHTML = f[1] + a + f[2]; d--;) p = p.lastChild;
                        if (!M.support.tbody) {
                            var h = ye.test(a),
        ...
        try {
            qe = F.href
        } catch(e) { (qe = O.createElement("a")).href = "",
            qe = qe.href
        }
        Be = nt.exec(qe.toLowerCase()) || [],
        M.fn.extend({
            load: function(e, n, r) {
        ...
        M.extend({
            ...
            ajax: function(e, n) {
                ...
                d.url = ((e || d.url) + "").replace($e, "").replace(Ke, Be[1] + "//"), d.dataTypes = M.trim(d.dataType || "*").toLowerCase().split(et), null == d.crossDomain && (c = nt.exec(d.url.toLowerCase()), d.crossDomain = !(!c || c[1] == Be[1] && c[2] == Be[2] && (c[3] || ("http:" === c[1] ? 80 : 443)) == (Be[3] || ("http:" === Be[1] ? 80 : 443)))), d.data && d.processData && "string" != typeof d.data && (d.data = M.param(d.data, d.traditional)), x(it, d, n, T), 2 === w) return ! 1;
                if (u = d.global, d.type = d.type.toUpperCase(), d.hasContent = !Ze.test(d.type), u && 0 == M.active++&&M.event.trigger("ajaxStart"), !d.hasContent && (d.data && (d.url += (Ge.test(d.url) ? "&": "?") + d.data, delete d.data), i = d.url, !1 === d.cache)) {
                    var S = M.now(),
                    E = d.url.replace(tt, "$1_=" + S);
                    d.url = E + (E === d.url ? (Ge.test(d.url) ? "&": "?") + "_=" + S: "")
...
function(e, t) {
    function n() {
        d("#transTarget").css("height", "auto");
        var e = d("#inputOriginal").height(),
        t = d("#transTarget").height(),
        n = Math.max(e, t);
        d("#inputOriginal").css("height", n),
        d("#transTarget").css("height", n)
    }
    function r(e) {
        for (var t = e.translateResult,
        n = [], r = 0, i = M(L.state.type), o = 0; o < t.length; o++) {
            var a = t[o],
            s = [];
            r += a.length;
    ...
    function a(e) {
        function t(e) {
            var t = d("#langSelect span.select-text").text().indexOf("妫€娴嬪埌") > -1,
            n = d.trim(d("#langSelect span.select-text").text()).replace("妫€娴嬪埌锛�", "").replace(/\s+/g, "");
            if (n.indexOf("禄") < 0) {
                if ("from" === e) return "auto";
                if ("to" === e) return "auto"
            }
            return n = n.split("禄"),
            "from" === e ? t ? "auto": o(n[0]) : "to" === e ? t ? "auto": o(n[1]) : void 0
        }
        var n = d.trim(w.val());
        n = n.replace(/\n/g, "").replace(/\r\n/g, "");
    ...
    function s(e) {
        if (0 == d('li[data-value="' + e + '"]').length) d("#langSelect").selectValue("AUTO");
        else {
            d("#langSelect").selectValue(e);
            var t = d(".select-text").text();
            L.state.isSelectLan || d(".select-text").text("妫€娴嬪埌锛�" + t)
        }
    }
    function l(e) {
        d(".fanyi-error-message").html(""),
        e && 0 == e.errorCode ? (L.state = d.extend(L.state, e), s(L.state.type), r(e), e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (b.clog("RESULT_DICT_SHOW"), y.render(e.translateResult[0][0].src, e.smartResult)) : y.hide(), h.showVoice(L.state.type)) : e && e.errorCode > 0 ? (y.hide(), d("#langSelect").selectValue("AUTO"), i(O.errorMsg[e.errorCode])) : T.html(""),
        R()
    }
    function c(e, t) {
    ...
    function u(e, t) {
        "zh-CHS2en" != L.state.type && "en2zh-CHS" != L.state.type || (d(e).hasClass("show-suggest") ? f() : (d(e).addClass("show-suggest"), A.hide(), x.asyRequest({
            i: t.i,
            client: k,
            tgt: t.tgt,
            from: t.from,
            ...
            success: function(t) {
                ...
                r = e.position().left,
                i = e.height();
                d("#transTarget .will-update").removeClass("will-update");
    ...
    function f() {
        d(".show-suggest").removeClass("show-suggest"),
        A.hide()
    }
    var d = e("./jquery-1.7"),
    p = e("./utils"),
    ...
    function() {
        ...
        function r(e) {
            ...
            n = e.position().left,
            r = e.width();
            "zh-CHS2en" != L.state.type && "en2zh-CHS" != L.state.type || (d(".fanyi__update__tip").css({
                top: t - d(".fanyi__update__tip").height() - 5,
                left: 10 + n + r / 2
            }), i(), j = setTimeout(function() {
                d(".fanyi__update__tip").fadeIn()
            },
            500))
        }
        function i() {
            j && (clearTimeout(j), j = "", d(".fanyi__update__tip").stop(!0, !0)),
            d(".fanyi__update__tip").hide()
        }
        function o() {
            N && (clearInterval(N), N = "")
        }
        ...
        function() {
            if (!g) {
                ...
                r(e),
                d("#transTarget span.hover").removeClass("hover"),
                e.addClass("hover"),
        ...
        d("#fanyiSuggest").delegate("li", "click",
        function() {
            var e = L.state.updateEle,
            t = d(this).text(),
            r = d(this).attr("systemName"),
            i = d(this).index();
            L.state.isUpdate = !0,
            e.text(t),
            n(),
        ...
        function(e) {
            var t = d(e.target);
            0 != t.parents("#transTarget").length && "SPAN" == t[0].tagName || (d("#transTarget .will-update").removeClass("will-update"), f())
        }),
        d(".suggest__title--close").on("click",
        function() {
            f()
        }),
        T.delegate("span", "mouseout",
        function() {
            g || (d("#transTarget span.hover").removeClass("hover"), D || w.selectRange({
                start: 0,
                end: 0
            }), i())
        }),
        d(".input__target").on("mousedown",
        function(e) {
            o(),
            g = !0,
            d("#transTarget span.hover").removeClass("hover"),
        ...
        d(".input__target").on("mouseup",
        function(e) {
            null == p.getSelectionText() && (g = !1),
            a()
        }),
        d(".suggest__update__btn").on("click",
        function() {
            b.clog("RESULT_SINGEL_MODIFY_CLICK"),
            d("#updateResult").trigger("click", [!0])
        })
    } (),
    t.translate = function(e, t) {
        ...
        if (R(), _.text(i), i > 5e3) {
            ...
            d("#inputTargetError").text("鏈夐亾缈昏瘧瀛楁暟闄愬埗涓�5000瀛楋紝鈥�" + s + "鈥濆強鍏跺悗闈㈡病鏈夎缈昏瘧!").show(),
            _.addClass("fonts__overed")
        } else _.removeClass("fonts__overed"),
        d("#inputTargetError").hide();
        p.isWeb(n) ? a() : c({
            i: n,
            from: S,
            to: E,
...
function(e) {
    ...
    return {
        ...
        isWeb: function(e) {
            return /\b((?:[a-z][\w\-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]|\((?:[^\s()<>]|(?:\([^\s()<>]+\)))*\))+(?:\((?:[^\s()<>]|(?:\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?芦禄鈥溾€濃€樷€橾))/i.test(e.toLocaleString())
        },
        addToFav: function() {
        ...
        throttle: function(e, t, n, r) {
            ...
            function o() {
                ...
                u = Date.now() - l,
                f = arguments;
                s || (r && !a && o(), i(), void 0 === r && u > e ? o() : !0 !== t && (a = setTimeout(r ?
                function() {
                    a = void 0
                }: o, void 0 === r ? e - u: e)))
            }
